...
% ===== Judul & deadline =====
\title{\textbf{Assignment 2: Mesh Editor}}
\author{} % tidak dipakai
\date{Deadline: xx October 2025 pukul 23.59 WIB}
...
\input{1_material_explanation}

\input{2_code_flow}

\input{3_specifications_submission}

\input{4_submission_format}
